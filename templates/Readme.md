...
The templates in [tfplugindocs](https://github.com/hashicorp/terraform-plugin-docs) are implemented with Go [
...
Use [resources/ssh_key.md.tmpl](resources/ssh_key.md.tmpl) as an example to add templates for a
resource.
...
See [the HashiCorp documentation](https://github.com/hashicorp/terraform-plugin-docs?tab=readme-ov-file#templates) for a
full list of data fields and functions.
